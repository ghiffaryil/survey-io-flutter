...
class SurveyDesignPaymentWebview extends StatefulWidget {
  final String url;

  const SurveyDesignPaymentWebview({super.key, required this.url});

  @override
  State<SurveyDesignPaymentWebview> createState() =>
      _SurveyDesignPaymentWebviewState();
}

class _SurveyDesignPaymentWebviewState
    extends State<SurveyDesignPaymentWebview> {
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: SecondaryAppBar(
          ...
          title: const Text('Pembayaran Survei'),
