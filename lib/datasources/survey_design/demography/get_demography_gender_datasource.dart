...
class GetDemographyGenderDatasource {
  Future<Either<String, DemographyGenderResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/demography/gender'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(DemographyGenderResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
