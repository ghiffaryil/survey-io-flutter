...
class GetDemographyRegionDatasource {
  Future<Either<String, DemographyRegionResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/demography/region'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(DemographyRegionResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
