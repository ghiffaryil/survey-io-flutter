...
class GetDemographyChildrenDatasource {
  Future<Either<String, DemographyChildrenResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/demography/children'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(DemographyChildrenResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
