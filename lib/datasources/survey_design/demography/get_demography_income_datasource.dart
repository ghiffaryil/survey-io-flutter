...
class GetDemographyIncomeDatasource {
  Future<Either<String, DemographyIncomeResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/demography/income'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(DemographyIncomeResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
