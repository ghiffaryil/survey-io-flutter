...
class GetDemographyOutcomeDatasource {
  Future<Either<String, DemographyOutcomeResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/demography/outcome'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(DemographyOutcomeResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
