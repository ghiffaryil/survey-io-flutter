...
class GetDemographyOccupationDatasource {
  Future<Either<String, DemographyOccupationResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/demography/occupation'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(
              DemographyOccupationResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
