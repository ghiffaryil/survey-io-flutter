...
class GetSurveyRespondentDatasource {
  Future<Either<String, SurveyRespondentResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/respondent'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(SurveyRespondentResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
