...
class GetSurveyScopeDatasource {
  Future<Either<String, SurveyScopeResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/scope'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(SurveyScopeResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
