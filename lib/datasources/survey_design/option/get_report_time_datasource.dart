...
class GetSurveyReportTimeDatasource {
  Future<Either<String, SurveyReportTimeResponseModel>> getData() async {
    ...
    if (token.isEmpty) {
      ...
      final request = http.Request(
        'GET',
        Uri.parse('${Variables.baseURL}/survey/report-time'),
      );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          return Right(SurveyReportTimeResponseModel.fromJson(responseBody));
        } else {
          print('No Data');
