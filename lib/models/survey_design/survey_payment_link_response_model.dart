...
class SurveyPaymentLinkResponseModel {
    ...
    factory SurveyPaymentLinkResponseModel.fromJson(String str) => SurveyPaymentLinkResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory SurveyPaymentLinkResponseModel.fromMap(Map<String, dynamic> json) => SurveyPaymentLinkResponseModel(
